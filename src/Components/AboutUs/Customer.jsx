        ...
        <div className="md:flex flex-wrap justify-between items-center">
          ...
          <div className="px-4 text-center lg:text-start">
            ...
            <p className="font-dm font-normal text-base xl:text-lg text-light_black leading-121 max-w-[785px] lg:w-[576px] xl:w-[785px] md:mt-3">
              100+ Strong, One Vision At Cynor Media, we’re proud to be a team
              of 100+ passionate professionals, each driven by creativity,
              dedication, and a shared goal — to deliver excellence in every
              project. Every member of our family brings unique energy and
              expertise, making us stronger together and unstoppable in
              execution. Together, we don’t just complete tasks — we create
              impact.
            </p>
