...
const ReadyToElevate = () => {
  ...
  return (
    <div className="my-10 lg:mt-[63px] lg:mb-24 px-4">
      <div className="max-w-[1440px] h-[52vh] xsm:h-[60vh] sm:h-[50vh] md:h-[63vh] lg:h-[50vh] xl:h-[65vh] 2xl:h-[70vh] mx-auto py-5 px-3 lg:ps-20 lg:pt-7 lg:pb-28 bg-[#0c0c0c] rounded-3xl">
