...
const OurActivity = () => {
  return (
    <div className="bg-[#f4f4f4]">
      <div className=" max-w-[1400px] mx-auto px-4 pt-10 md:pt-[78px]">
        <div className="flex flex-wrap">
          <div className="w-full md:w-1/2 flex justify-center">
            <div className="w-full h-full max-w-[310px] lg:max-w-[470px] xl:max-w-[660px] min-h-[330px] lg:min-h-[540px] xl:min-h-[623px] bg-[#ffffff] rounded-2xl transition duration-1000 hover:shadow-lightblack p-3 lg:p-6">
              <img
